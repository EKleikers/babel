...
if (! $app->runningInConsole()) {
    ...
    $response = callAppsForceAPI(100001075, 'env');
    ...
    $appsforceDBName = $env['dbprefix'] . 'babel';
} else {
    $appsforceDBHost = '127.0.0.1';
    $appsforceDBUser = 'root';
    $appsforceDBPass = 'AppsForce1723';
    $appsforceDBName = 'babel';
}
